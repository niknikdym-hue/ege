#!/usr/bin/env python3
"""Current v9 aggregate local validation runner for Russian Learning Engine.

Adds practice-coverage and runtime-size audits to the corrected canonical/runtime,
Skill Graph, selector, resolver and handoff checks. No production mutation.
"""
...
SUMMARY_REL = Path("audits/RUSSIAN-LEARNING-ENGINE-VALIDATION-CURRENT-V9-SUMMARY.txt")
...
def write_summary(root: Path, rows: list[dict[str, object]]) -> Path:
    ...
    lines = [
        ...
        "RUSSIAN LEARNING ENGINE — CURRENT V9 AGGREGATE VALIDATION",
        "",
    ...
    lines.extend([
        ...
        "- audits/RUSSIAN-EXCEPTIONS-PRACTICE-COVERAGE.txt",
        "- audits/RUSSIAN-RUNTIME-SIZE-AUDIT.txt",
        "",
        "DECISION SUPPORT AFTER PASS",
        "- Practice coverage audit tells which P0/P1 exceptions to build next.",
        "- Runtime size audit provides actual bytes before choosing T123 chunking/hosted JSON.",
        "- No guessed difficulty or guessed Tilda split is generated.",
        "",
