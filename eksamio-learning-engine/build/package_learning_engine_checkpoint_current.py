#!/usr/bin/env python3
"""Create a checkpoint ZIP gated by the CURRENT aggregate validation summary."""
...
CURRENT_SUMMARY = Path("audits/RUSSIAN-LEARNING-ENGINE-VALIDATION-CURRENT-SUMMARY.txt")
