#!/usr/bin/env python3
"""Build current corrected canonical Russian Exceptions Bank.

Uses current manifest 118 and filters explicitly disabled historical/superseded
exception IDs before validation/output. Data-only; no production mutation.
"""
