#!/usr/bin/env python3
"""Current v7 aggregate local validation runner for Russian Learning Engine.

Adds minimal Explanation Runtime build to the hardened corrected source/data,
Exceptions Runtime, selector, Skill Graph and handoff checks.
...
SUMMARY_REL = Path("audits/RUSSIAN-LEARNING-ENGINE-VALIDATION-CURRENT-V7-SUMMARY.txt")
...
def write_summary(root: Path, rows: list[dict[str, object]]) -> Path:
    ...
    lines = [
        ...
        "RUSSIAN LEARNING ENGINE — CURRENT V7 AGGREGATE VALIDATION",
        "",
    ...
    lines.extend([
        ...
        "",
        "RUNTIME SAFETY",
        "- Explanation Runtime excludes raw books/source provenance and does not own answers/scoring.",
        "- Exceptions Runtime is generated only from canonical source/practice data.",
