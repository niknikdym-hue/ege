#!/usr/bin/env python3
"""Create a checkpoint ZIP gated by the current v2 aggregate validation."""
...
CURRENT_SUMMARY = Path("audits/RUSSIAN-LEARNING-ENGINE-VALIDATION-CURRENT-V2-SUMMARY.txt")
