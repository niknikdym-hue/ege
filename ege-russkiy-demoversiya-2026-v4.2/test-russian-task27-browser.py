...
with sync_playwright() as p:
    ...
    check(saved['analysisStatus']=='pending','analysis stays pending after finish until explicit check')
    ...
    check(page.locator('details.edemo-criterion-help').count()==6,'K1-K6 help is available before explicit text check')
